              ...
              _expandableSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Ethnicity", value: _val(data?.ethnicity)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Religious Practice", value: _val(data?.religiousPractice)),
                    widget.dimens.k5.verticalBoxPadding,
              ...
              _expandableSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Living Arrangement", value: _val(data?.livingArrangement)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Siblings Married", value: _val(data?.married)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Siblings Unmarried", value: _val(data?.unmarried)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "House Size", value: _val(data?.houseSize)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Society / Area", value: _val(data?.areaSociety)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Can Move Abroad for Marriage", value: _val(data?.canMoveAbroadForMarriage)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Children", value: _val(data?.haveChildern)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Additional Family Details", value: _val(data?.otherFamilyDetails)),
                    widget.dimens.k5.verticalBoxPadding,
                  ],
                ),
              ),
              ...
              _expandableSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Job Title / Role", value: _val(data?.jobTitle)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Monthly Income", value: _val(data?.incomeRange)),
                    widget.dimens.k5.verticalBoxPadding,
                    _detailItem(label: "Business", value: _val(data?.businessText)),
                    widget.dimens.k5.verticalBoxPadding,
                  ],
                ),
              ),
