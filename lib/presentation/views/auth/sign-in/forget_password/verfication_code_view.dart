...
class ForgetPasswordOTPView extends BaseStateFullWidget {
  ...
  ForgetPasswordOTPView({super.key, this.email});

  @override
  State<ForgetPasswordOTPView> createState() => _VerificationCodeViewState();
}

class _VerificationCodeViewState extends State<ForgetPasswordOTPView>
