...
class ChatBlockView extends BaseStateFullWidget {
  ChatBlockView({super.key});

  @override
  State<ChatBlockView> createState() =>
      _ChatBlockViewState();
}
class _ChatBlockViewState extends State<ChatBlockView>
    with AuthMixin
    implements Result {
  @override
